...
// Functions lists all functions in the table.
...
// Function represents a function entry in the table. Note that some functions
// may be inlined by the compiler, and not appear in the table.
